...
#       Allow remote search and listing of Scoop's known public buckets. Defaults to $true. Only a boolean true enables it.
#
# defaultBucket: [string]
#       Bucket searched first for unqualified app names, and assumed for installed apps that recorded no bucket. Defaults to 'main'.
#
# ARIA2 configuration
# -------------------
#
